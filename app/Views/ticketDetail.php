    ...
    <div class="container">
        ...
        if ($session->has('auth_user')) {
            ...
            if ($conn->connect_error) {
                ...
                $ticketDetails = "Sefer Tarihi: " . $row['Sefer Tarihi'] . "\n";
                $ticketDetails .= "İlk Durak: " . strtoupper($row['İlk Durak']) . "\n";
                $ticketDetails .= "Son Durak: " . strtoupper($row['Son Durak']) . "\n";
                $ticketDetails .= "Alınan Koltuk: " . $row['Koltuk'] . "\n";
                $ticketDetails .= "Bilet Tarihi: " . $row['Bilet Tarihi'] . "\n";
                $ticketDetails .= "Araç Plaka: " . $row['Plaka'] . "\n";
                $ticketDetails .= "PNR Kodu: " . $row['pnr_code'];

                ?>
                <div class="row custom-border">
                    <div class="col-md-9">İşlem Tarihi</div>
                    <div class="col-md-3" style="text-align: right; ">
                        <?php echo $row['İşlem Tarihi']; ?>
                    </div>
                </div>
                <div class="row custom-border">
                    <div class="col-md-9">Sefer Tarihi</div>
                    <div class="col-md-3" style="text-align: right; ">
                        <?php echo $row['Sefer Tarihi']; ?>
                    </div>
                </div>
                <div class="row custom-border">
                    <div class="col-md-9">İlk Durak</div>
                    <div class="col-md-3" style="text-align: right;">
                        <?php echo strtoupper($row['İlk Durak']); ?>
                    </div>
                </div>
                <div class="row custom-border">
                    <div class="col-md-9">Son Durak</div>
                    <div class="col-md-3" style="text-align: right; ">
                        <?php echo strtoupper($row['Son Durak']); ?>
                    </div>
                </div>
                <div class="row custom-border">
                ...
                <div class="row custom-border">
                    <div class="col-md-9">PNR Kodu</div>
                    <div class="col-md-3" style="text-align: right;">
                        <?php echo $row['pnr_code']; ?>
                    </div>
                </div>
