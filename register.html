        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="col-md-12" id="divUyeKontrol" style="margin-top:20px;">
                        <button type="button" class="btn btn-primary pull-right" id="btnUyeKontrol" name="btnUyeKontrol" onclick="uyeKontrolEt()">Devam</button>
                    </div>
                </div>
                <div class="col-md-6">
                    <div id="tblDigerBilgiler" class="diger_bilgiler" style="display: none;">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12" style="padding-top: 15px;">
                              <button type="button" class="btn btn-primary pull-right" onclick="uyeKaydet()" id="btnGonder" name="btnGonder">Kaydet</button>
                            </div>
                        </div>
                    </div>
                </div>
